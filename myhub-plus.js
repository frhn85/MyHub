...
document.addEventListener('DOMContentLoaded',()=>{if(!currentAccount()){accountGate();return}inject();setupLock();injectAccountSettings();if(localStorage.getItem(accountKey('myhubLocked'))==='true'&&localStorage.getItem(accountKey('myhubPin')))document.getElementById('myhubLock').classList.add('show');});
})();
